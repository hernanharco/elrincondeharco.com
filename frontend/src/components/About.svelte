    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <div class="relative">
        <div class="relative h-[500px] w-full rounded-2xl overflow-hidden shadow-2xl group">
          <img
            src="https://images.unsplash.com/photo-1631624220291-8f191fbdb543?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBkZXZlbG9wZXIlMjBtYW4lMjBjb2RpbmclMjBvZmZpY2V8ZW58MXx8fHwxNzcwNDgwNjI4fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
          ...
          <div class="absolute bottom-6 left-6 text-white">
            <p class="flex items-center gap-2 text-amber-400 font-medium">
              <MapPin size={18} /> Avilés, Asturias, España
            </p>
          </div>
        </div>
        <!-- Decorative box -->
      ...
      <div class="space-y-6">
        <h2 class="text-3xl md:text-4xl font-bold">
          <span class="text-amber-400">14+ Años</span> de Trayectoria Profesional
        </h2>

        <div class="space-y-4 text-gray-300 leading-relaxed">
          <p>
            Mi nombre es Hernan Arango Cortes. Hace aproximadamente 5 años que resido en
            <span class="text-white font-medium"> Avilés, Asturias</span>, donde me he especializado
            en las tecnologías más modernas para ofrecer los mejores servicios a mis futuros
            clientes.
          </p>
          ...
          <p>
            ...
            llamé el
            <span class="text-amber-400 font-bold"> "Equipo de Oro"</span>.
          </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
          ...
          >
            ...
            <h3 class="font-semibold text-white">Liderazgo</h3>
            <p class="text-sm text-gray-400">Formación de equipos de alto rendimiento.</p>
          </div>
          <div
            class="p-4 bg-white/5 rounded-xl border border-white/10 hover:border-amber-500/50 transition-colors"
          >
            ...
            <p class="text-sm text-gray-400">Más de una década entregando soluciones.</p>
          </div>
        </div>
      </div>
    </div>
