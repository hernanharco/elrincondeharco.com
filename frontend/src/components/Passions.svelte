  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      <div class="order-2 lg:order-1 space-y-8">
        ...
        <div class="space-y-6">
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="text-xl font-semibold text-white mb-1">Mi Familia</h3>
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="text-xl font-semibold text-white mb-1">Videojuegos</h3>
              <p class="text-gray-400">
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="text-xl font-semibold text-white mb-1">Programación</h3>
              <p class="text-gray-400">
      ...
      <div class="order-1 lg:order-2 relative">
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1758687126556-b2d1c32e4207?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx2aWRlbyUyMGdhbWVzJTIwY29udHJvbGxlciUyMGZhbWlseSUyMGxpdmluZyUyMHJvb218ZW58MXx8fHwxNzcwNDgwNjI4fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
